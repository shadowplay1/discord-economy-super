...
declare class RewardManager {
    ...
    */
    ...
    >(memberID: string, guildID: string, reason?: string): Promise<RewardObject<isRewardArray, 'daily'>>
    ...
    */
    ...
    >(memberID: string, guildID: string, reason?: string): Promise<RewardObject<isRewardArray, 'work'>>
    ...
    */
    public getWeekly<
        isRewardArray extends boolean = false
    >(memberID: string, guildID: string, reason?: string): Promise<RewardObject<isRewardArray, 'weekly'>>
}
