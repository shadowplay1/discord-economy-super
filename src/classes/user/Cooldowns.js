...
class Cooldowns {
     ...
     */
    clearDaily() {
        const result = this._database.delete(`${guildID}.${memberID}.dailyCooldown`)
        return result
    }
     ...
     */
    clearWork() {
        const result = this._database.delete(`${guildID}.${memberID}.workCooldown`)
        return result
    }
     ...
     */
    clearWeekly() {
        const result = this._database.delete(`${guildID}.${memberID}.weeklyCooldown`)
        return result
    }
}
