...
declare class CooldownManager {
    ...
    */
   async getAll(memberID: string, guildID: string): Record<'daily' | 'work' | 'weekly' | 'monthly' | 'hourly', RewardCooldownData>
    ...
    */
   public clearAll(memberID: string, guildID: string): boolean
   ...
   * @returns {boolean} If cleared: true; else: false.
   */
   public clearMonthly(memberID: string, guildID: string): boolean
   ...
   * @returns {boolean} If cleared: true; else: false.
   */
   public clearHourly(memberID: string, guildID: string): boolean
   ...
   * @returns Cooldown end timestamp.
   */
   public getMonthly(memberID: string, guildID: string): number
   ...
   * @returns Cooldown end timestamp.
   */
   public getHourly(memberID: string, guildID: string): number
}
